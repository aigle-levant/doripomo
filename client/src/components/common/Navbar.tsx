...
export default function Navbar() {
  return (
    <nav
      id="navbar"
      className="bg-bg text-text z-10 flex flex-row justify-between items-center gap-5 mx-10 rounded-full py-4 px-7 my-6"
    >
      ...
      <div id="theme-and-auth" className="font-body flex flex-row gap-10 pr-1">
        ...
        <button
          type="button"
          className="rounded-3xl px-6 py-3 bg-bg dark:bg-primary-forest hover:border-secondary-matcha 
